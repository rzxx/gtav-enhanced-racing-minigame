...
namespace StreetRacing
{
    ...
    ///
    /// samples columns (legacy 42 first, then joint-maneuver extensions):
    ...
    /// events: START / ROUTE / GPS_ROUTE / TACTIC / ROUTE_LOST / ROUTE_FOUND /
    ///   RECOVERY / IMPACT / TELEPORT / HARD_BRAKE / CTRL / ACTUATOR /
    ///   PLAN (planner changes: chosen candidate, speed, limiting, which
    ///   actor constrained which station, clearance) /
    ...
    internal sealed class RaceTelemetry
    {
            ...
            float steerDeg, float thr01, float brk01, float localVTgt)
        {
            ...
            samples.WriteLine(string.Format(CultureInfo.InvariantCulture,
                "{0},{1},{2},{3:F0},{4:F3},{5:F0},{6:F1},{7:F1},{8:F1},{9:F0},{10:F4},{11:F1},{12:F2},{13:F1},{14:F2},{15:F1},{16:F1},{17},{18:F2},{19:F1},{20:F1},{21},{22:F0},{23:F1},{24:F1},{25:F1},{26},{27},{28},{29},{30:F0},{31},{32:F1},{33:F1},{34:F1},{35:F1},{36:F1},{37:F0},{38:F2},{39},{40},{41:F1},{42:F4},{43},{44:F1},{45:F1},{46},{47},{48:F0},{49:F1},{50},{51:F1},{52:F2},{53:F2},{54:F1}",
                ...
                steerDeg, thr01, brk01, localVTgt));
            if (++sampleCount % 50 == 0)
            {
